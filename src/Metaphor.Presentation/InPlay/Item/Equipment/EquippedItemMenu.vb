...
Friend Class EquippedItemMenu
    ...
    Public Overrides ReadOnly Property PromptText As String
        Get
            Return $"Do what with equipped {itemModel.Name}?"
        End Get
    End Property
    ...
    Friend Shared Function Launch(c As IDisplayContext, m As IWorldModel, p As DialogSource, itemModel As IItemModel) As DialogSource
        Return Function() New EquippedItemMenu(c, m, p, itemModel)
    End Function
    ...
    Private Function ChooseNeverMind(context As IDisplayContext, model As IWorldModel, previous As DialogSource) As IDialogChoice
        Return DialogChoice.CreateEnabled("Never Mind", EquipmentMenu.Launch(context, model, previous))
    End Function
End Class
